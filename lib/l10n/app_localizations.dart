...
abstract class AppLocalizations {
  ...
  /// No description provided for @addDishLabel.
  ///
  /// In en, this message translates to:
  /// **'Add Dish'**
  String get addDishLabel;

  /// No description provided for @editDishLabel.
  ///
  /// In en, this message translates to:
  /// **'Edit Dish'**
  String get editDishLabel;
  ...
  /// No description provided for @saveDishLabel.
  ///
  /// In en, this message translates to:
  /// **'Save Dish'**
  String get saveDishLabel;
