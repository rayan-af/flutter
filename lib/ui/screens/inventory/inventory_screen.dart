...
class _InventoryScreenState extends ConsumerState<InventoryScreen> {
                               ...
                               child: Row(
                                 children: [
                                   ...
                                   if (!widget.isReadOnly)
                                      IconButton(
                                        icon: const Icon(Icons.check, size: 16, color: Colors.blue),
                                        onPressed: () => _showRestockDialog(context, item, ref.read(inventoryProvider.notifier)),
                                      )
                                   else
  ...
  void _showRestockDialog(BuildContext context, InventoryModel item, InventoryNotifier provider) {
